...
namespace DriveFlow_CRM_API.Migrations
{
    ...
    [Migration("20260126204430_RemoveIsLockedFromSessionForm")]
    partial class RemoveIsLockedFromSessionForm
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DriveFlow_CRM_API.Models.ExamForm", b =>
                {
                    b.HasOne("DriveFlow_CRM_API.Models.TeachingCategory", "TeachingCategory")
                        .WithOne()
                        .HasForeignKey("DriveFlow_CRM_API.Models.ExamForm", "TeachingCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
